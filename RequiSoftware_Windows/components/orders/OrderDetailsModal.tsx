...
import ProviderPerformanceModal from '../inventory/ProviderPerformanceModal'; // Nueva importación
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
          ...
          <div className="p-4 sm:p-6 space-y-4 overflow-y-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-6 gap-y-4 text-sm">
              ...
              <div>
                <p className="font-medium text-gray-500 dark:text-gray-400">Fecha Entrega Estimada:</p>
                <p className="text-gray-800 dark:text-gray-200">{order.fecha_entrega_estimada ? new Date(order.fecha_entrega_estimada).toLocaleDateString() : 'N/A'}</p>
              </div>
              <div>
                <p className="font-medium text-gray-500 dark:text-gray-400">Fecha Entrega Real:</p>
                <p className="text-gray-800 dark:text-gray-200">{order.fecha_entrega_real ? new Date(order.fecha_entrega_real).toLocaleDateString() : 'N/A'}</p>
              </div>
              <div>
          ...
          <div className="p-4 sm:p-5 border-t dark:border-gray-700 flex justify-between items-center sticky bottom-0 bg-white dark:bg-gray-800 z-10">
            <div>
              {order.estado === 'Completada' && order.proveedor_id && (
                <button
                  ...
                  title="Evaluar Rendimiento del Proveedor"
                >
