...
const MenuCard: React.FC<MenuCardProps> = ({ title, description, icon: Icon, onClick, color = 'bg-primary-500' }) => (
  <button
    onClick={onClick}
    className="group bg-white dark:bg-gray-800 shadow-xl rounded-xl p-6 hover:shadow-2xl transform hover:-translate-y-1 transition-all duration-300 ease-in-out flex flex-col justify-between items-start w-full text-left h-full"
  ...
  >
    ...
    <div className="flex items-center text-sm font-medium text-primary-600 dark:text-primary-400 group-hover:underline mt-auto pt-2">
      Acceder
