...
interface ConsolidatedOrderTableProps {
  ...
  onOrderClick: (order: OrdenConsolidada) => void; // Para modal de detalles
...
const ConsolidatedOrderTable: React.FC<ConsolidatedOrderTableProps> = ({ orders, onOrderClick, onConvertToRegularOrder, onUpdate }) => {
  ...
  const getStatusBadge = (estado: string) => {
    const variants: { [key: string]: string } = {
      ...
      Procesada: 'bg-blue-100 text-blue-800 dark:bg-blue-800 dark:text-blue-100', // Asumiendo 'Procesada' al convertir
      Completada: 'bg-green-100 text-green-800 dark:bg-green-800 dark:text-green-100', // Si la orden consolidada puede ser completada
