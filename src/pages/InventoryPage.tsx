...
import ViewInventory from '../components/inventory/ViewInventory'; // Path relative to src/pages
import ProductManagement from '../components/inventory/ProductManagement'; // Path relative to src/pages
import ProviderManagement from '../components/inventory/ProviderManagement'; // Path relative to src/pages
import InventoryStats from '../components/inventory/InventoryStats'; // Path relative to src/pages
import DetailedStats from '../components/inventory/DetailedStats'; // Path relative to src/pages
import AIInsights from '../components/ai/AIInsights'; // Path relative to src/pages
...
// Default export was removed, now it's a named export: export const InventoryPage
// If it's intended to be default, change to: export default InventoryPage;
